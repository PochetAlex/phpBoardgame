<div class="msg-info {{$type}} bg-white border-l-4 p-4 mb-4">
    <div class="msg-icon flex-none">
        @if($type == 'primary')
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 class="fill-current text-green-500 h-4 w-4">
                <path
                    d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-1.25 16.518l-4.5-4.319 1.396-1.435 3.078 2.937 6.105-6.218 1.421 1.409-7.5 7.626z"/>
            </svg>
        @elseif($type == 'warning')
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 class="fill-current text-blue-500 h-4 w-4">
                <path
        ...
        @else
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 class="fill-current text-red-500 h-4 w-4">
                <path
    ...
    <div class="msg ml-4 text-gray-700">
        {{$message}}
    </div>
</div>
